$(document).ready(function() {
    ...
    $(window).ready(function() {
		...
		$('.connection').html('<a class="grey-text"><i class="fa fa-lock grey-text" aria-hidden="true"></i> Secure connection</a>');
		protocol += " You are using https";
	    } else {
		$('.connection').html('<a class="grey-text"><i class="fa fa-unlock-alt grey-text" aria-hidden="true"></i> Unsecure connection</a>');
